...
import { QccDashboardBreakdown } from "../hooks/useQccDashboard";
...
const gradientKey = "qcc_breakdown";

interface Props {
  breakdown: QccDashboardBreakdown[];
  loading: boolean;
  selectedSite: string | null;
}

export function QccSiteDetailsCharts({ breakdown, loading, selectedSite }: Props) {
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <CardTitle className="text-xl sm:text-2xl font-bold">
              Pencapaian QCC {selectedSite} per{" "}
