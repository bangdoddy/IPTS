// src/components/questionnaire/CreateModulePicker.tsx
...
export default function CreateModulePicker() {
        ...
        {modules.map((m) => {
          ...
          return (
            <Card
              key={m.id}
              className={cn(
                "group hover:shadow-xl transition-all duration-300 cursor-pointer overflow-hidden bg-card"
              )}
