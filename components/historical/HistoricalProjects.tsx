...
/** Historical SS: hanya ide dengan status Complete */
...
export function HistoricalProjects() {
  ...
  const requestBodyList = useMemo(
    ...
    [currentPage, startDate, endDate, keywordDebounced]
  );
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold text-white">Historical Projects</h1>
        <p className="text-sm text-white/90 mt-1">Suggestion System (SS) — completed ideas only</p>
      </div>
